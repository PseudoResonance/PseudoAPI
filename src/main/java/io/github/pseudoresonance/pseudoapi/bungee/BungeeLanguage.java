...
public class BungeeLanguage {
	...
	/**
	 * Constructs new {@link BungeeLanguage} with the given name
	 * 
	 * @param lang Localization name
	 */
	public BungeeLanguage(String lang) {
		this.lang = lang;
	}
	...
	public String getMessage(String key, Object... args) {
		...
		if (msg == null)
			msg = BungeeLanguageManager.getLanguage().getUnprocessedMessage(key);
		if (msg != null) {
